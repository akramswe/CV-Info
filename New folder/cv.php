...
$sql = "SELECT * FROM education  where e_id= 3 ";
$result = mysqli_query($conn, $sql);
if(mysqli_num_rows($result) > 0)
{
 while($row = mysqli_fetch_assoc($result))
            ...
            <div class="right_content">
                <div class="education">
                    ...
                    <div class="edu_des">
                        ...
                        <div class="Enames">
                            <h1>SSC<span>// Feb 2011 - Jun 2014</span></h1>
                        ...
                        <div class="Enames">
                            <h1>HSC <span>// Feb 2011 - Jun 2014</span></h1>
                            <h1><?php echo $college; ?></h1>
                            <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque.</p>
                        </div>
                        <div class="right_blackdots">
                            <img src="img/black-dot.png" alt="" class="blackdots">
                        ...
                        <div class="Enames">
                            <h1><?php echo $honours; ?> <span>// Feb 2011 - Jun 2014</span></h1>
                ...
                <div class="experience">
                    ...
                    <div class="edu_des">
                        ...
                        <div class="EXnames">
                            <h1><?php echo $cname; ?><span>// <?php echo $syear; ?> - <?php echo $eyear; ?></span></h1>
                            <h1>YOUR JOB HERE</h1>
                            <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque.</p>
                        </div>
                        <div class="right_blackdots">
