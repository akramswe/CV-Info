                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" id="item_category" name="Phone" value="<?php echo $honours; ?>" placeholder="Category" required>  </div>
                                                 <label class="control-label col-sm-2" for="item_category">University:</label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" id="item_category" name="website" value="<?php echo $university; ?>" placeholder="Category" required> </div>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="submit" class="btn btn-primary" name="update_item"><span class="glyphicon glyphicon-edit"></span> Edit</button>
...
$fname = $lname = $email = $gender = '';
   $sql = "SELECT * FROM experience where I";
  //$sql= "SELECT experience.ex_id, experience.company_name, experience.designation,experience.start_year,experience.end_year
//FROM experience JOIN tbluser ON experience.ID=tbluser.ID where experience.ID = 3";
$result = mysqli_query($conn, $sql);
if(mysqli_num_rows($result) > 0)
{
 while($row = mysqli_fetch_assoc($result))
  {
   $id = $row['experience.ex_id'];
  $cname = $row["experience.company_name"];
  $designation = $row["experience.designation"];
  $syear =  $row["experience.start_year"];
  $eyear =  $row["experience.end_year"];
?>
                <tr>
                    <td>
                        <?php echo $id; ?>
